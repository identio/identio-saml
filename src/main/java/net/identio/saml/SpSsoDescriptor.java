...
public class SpSsoDescriptor {
     ...
     *
     * @param signingCertificates The list of signing certificates
     ...
     *
     * @param wantAssertionsSigned True if the SP wants assertions to be signed
     * @return The current SpSsoDescriptor
     */
     ...
     *
     * @param authentRequestSigned True if the IDP wants authentication requests to be signed
     * @return The current SpSsoDescriptor
     */
     ...
     *
     * @param assertionConsumerServices List of assertion consumer endpoints
     * @return The current SpSsoDescriptor
     */
     ...
     *
     * @param nameIDFormat The NameId formats
     * @return The current SpSsoDescriptor
     */
