...
public class Assertion extends SignableSAMLObject {
	 ...
	 *
	 * @param xmlof
	 *            XMLOutputFactory used to generate the assertion
	 * @param version
	 *            SAML version
	 * @param issuer
	 *            Issuer identifier
	 ...
	 * @param subjectType
	 *            Subject type
	 * @param subjectConfirmationInResponseTo
	 *            Identifier of the previous request
	 * @param subjectConfirmationRecipient
	 ...
	 *
	 * @param parser
	 *            XMLStreamReader used to parse the document
	 * @param assertionDoc
	 *            Assertion DOM document
	 *
	 * @throws TechnicalException
