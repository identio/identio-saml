...
public class Validator {
	 ...
	 *            List of certificates to validate against
	 * @param certificateExpirationCheck
	 *            True if the certificate expiration check should be done
	 *
	 * @throws TechnicalException
	 *             Thrown when something went wrong when building the Validator
	 */
	 ...
	 *
	 * @throws TechnicalException
	 *             Thrown when something went wrong when validating the
	 *             signature
	 * @throws InvalidSignatureException
	 *             Thrown when the signature is invalid
	 * @throws NoSuchAlgorithmException
	 *             Thrown when the signing algorithm is not supported
	 */
	 ...
	 *
	 * @param object
	 *            The signed SAML object to validate.
	 *
	 * @return True if validated
	 *
	 * @throws UnsignedSAMLObjectException
	 *             Thrown when the object is not signed
	 * @throws UntrustedSignerException
	 *             Thrown if the signer is not trusted
	 * @throws TechnicalException
	 *             Thrown when something went wrong when validating the
	 *             signature
	 * @throws InvalidSignatureException
	 ...
	 *             Thrown if the usage conditions of the assertion are not met
	 */
