...
public class AuthentRequestBuilder {
     ...
     *
     * @param forceAuthent True to force authentication
     * @return The current AuthentRequestBuilder
     */
     ...
     *
     * @param authnContext Authentication contexts accepted
     * @param comparison   The type of comparison to use for this authentication context
     * @return The current AuthentRequestBuilder
     */
     ...
     *
     * @param passive True to force IDP to be passive
     * @return The current AuthentRequestBuilder
     */
     ...
     *
     * @param endpoint            The preferred endpoint
     * @param preferEndpointIndex Indicates if we want to reference it by index or by
     *                            binding/url
     * @return The current AuthentRequestBuilder
     */
     ...
     * @throws TechnicalException Thrown when something went wrong when building the request
     */
     ...
     *
     * @param authentRequest String containing the request
     * @param base64         Boolean to indicate that the string is Base64-encoded
     * @return Built request
     * @throws TechnicalException      Thrown when something went wrong when building the request
     * @throws InvalidRequestException Thrown when the request doesn't have the awaited format
     */
